...
Description of the variables:
* warfarin_concentration: Warfarin concentration (mg/L)
* warfarin_dosage: Warfarin dosage (mg)
* patient_age: Age of the patient (years)
* patient_sex: Binary sex of the patient (1=Male, 0=Female)

The time unit between each measurement is 20 hours.

Additionally these variables have the ranges of:
* warfarin_concentration: [0.0, 11.8]
* warfarin_dosage: [0.0, 153.0]
* patient_age: [21, 63]
* patient_sex: [0, 1]
